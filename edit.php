<?php
include "conect.php";
// Tangkap id yang dikirimkan lewat url
$id = $_GET['id'];
        ...
        <div class="pt-3 mt-5">
            <form action="<?= $base_url; ?>/update.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="title" name="nama" required value="<?= $data['nama']; ?>">
                </div>
                <div class="mb-3">
                    <label for="no" class="form-label">Contact student :</label>
                    <input class="form-control" type="number" id="no" name="contact" required value="<?= $data['contact']; ?>">
                </div>
                <div class="mb-3">
                    <label for="email" class="form-label">Email Student :</label>
                    <input class="form-control" type="email" id="email" name="email" required value="<?= $data['email']; ?>">
                </div>
                <div class="mb-3">
